...
import YellowMan from '../../images/yellow-man.png';
    ...
    <BlockLayout>
      <div className={styles.invest10Steps}>
        ...
        <p className={styles.usefulness100}>
          ...
          <span>{intl.formatMessage({ id: 'initialBlock.usefulness100' })}</span>&nbsp;
        ...
        <Button 
          type="primary"
          className={styles.buttonSortOut}
        >{intl.formatMessage({ id: 'initialBlock.sortOutInvesting' })}</Button>
      </div>
